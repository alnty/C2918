...
# vasya = Human("Vasya")
# dmitriy = Human("Dmitriy")
# car = Auto("Mercedes")


# car.add_passenger(vasya)
# car.add_passenger(dmitriy)
# car.print_passengers_names()

# _______________________SIMS_______________________
import random
    ...
    def life(self, day):
        ...
        if self.satiety < 20:
            ...
            if self.home.mess > 15:
                print("I want to chill, but there is such a mess...\n So I will clean the house.")
                self.clean_home()
            else:
                print("Let's chill!")
                self.chill()
